...
$id = $_GET['id'];
$select_query = "SELECT * FROM portfolio_details WHERE id = $id";
$from_db = mysqli_query($db_connect, $select_query);
$after_assoc = mysqli_fetch_assoc($from_db);

$email_add_from_login_page = $_SESSION['email_add_from_login_page'];
$select_name_query = "SELECT * FROM users WHERE email_address = '$email_add_from_login_page'";
$data_from_db = mysqli_query($db_connect, $select_name_query);
$after_assoc_name = mysqli_fetch_assoc($data_from_db);
                    ...
                    <div class="col-xl-9 col-lg-10">
                        <div class="single-blog-list">
                            <div class="blog-list-thumb mb-35">
                                <img src="img/portfolio/feature/<?= $after_assoc['portfolio_feature_photos'] ?>" alt="img">
                            </div>
                            <div class="blog-list-content blog-details-content portfolio-details-content">
                                <h2><?= $after_assoc['portfolio_title'] ?></h2>
                                <p> <?= $after_assoc['portfolio_text'] ?> </p>
                                ...
                                <ul>
                                    <li>
                                        <div class="post-avatar-img">
                                            <img src="img/profile_img/<?= $after_assoc_name['profile_img'] ?>" alt="img" style="width: 100px;">
                                        </div>
                                        <div class="post-avatar-content">
                                            <h5><?= $after_assoc_name['full_name'] ?></h5>
                                            <p><?= $after_assoc_name['email_address'] ?></p>
